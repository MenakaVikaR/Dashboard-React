    ...
    <div class="navbar-collapse collapse">
            ...
            <img src="assets/img/avatars/avatar.jpg" class="avatar img-fluid rounded me-1" alt="Charles Hall" /> <span class="text-dark">Charles Hall</span>
                        ...
                        <div class="dropdown-menu dropdown-menu-end">
                            <Link to='/profile' class="dropdown-item" onClick='reload()'><i class="align-middle me-1" data-feather="user"></i> Profile</Link>
                            <Link to='/dashboard' class="dropdown-item" onClick='reload()'><i class="align-middle me-1" data-feather="pie-chart"></i> Analytics</Link>
                            <div class="dropdown-divider"></div>
                            <a class="dropdown-item" href="index.html"><i class="align-middle me-1" data-feather="settings"></i> Settings & Privacy</a>
                            <a class="dropdown-item" href="#"><i class="align-middle me-1" data-feather="help-circle"></i> Help Center</a>
                            <div class="dropdown-divider"></div>
                            <Link to='/' class="dropdown-item" onClick='reload()'>Log Out</Link>
                        </div>
                    </li>
                </ul>
    </div>
