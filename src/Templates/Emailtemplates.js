...
class Registeruser extends React.Component {
    constructor() {
      ...
      formSubmit(){
        ...
        const recipeUrl = 'http://localhost:5000/record/email';
          const postBody = {
                ...
                <form method="post"  name="userRegistrationForm"  onSubmit= {this.submituserRegistrationForm} >
							<div class="card-forms">
								<div class="card-body card-form">
									...
									<input type="text" class="form-control" placeholder="Enter Your first name" name="firstname" value={this.state.fields.firstname} onChange={this.handleChange} />
                                    <div className="errorMsg">{this.state.errors.firstname}</div>
								</div>
                                <div class="card-body card-form">
                                    <label class="card-title mb-0">Email<span style={{color: "#cc0000"}}>*</span></label>
									<input type="email" class="form-control" placeholder="Enter Your email id" name="emailid" value={this.state.fields.emailid} onChange={this.handleChange}/>
                                    <div className="errorMsg">{this.state.errors.emailid}</div>
                                </div>
                                <div class="card-body card-form">
                                    <label class="card-title mb-0">Message<span style={{color: "#cc0000"}}>*</span></label>
									<input type="text" class="form-control" placeholder="Enter Your message" name="message" value={this.state.fields.message} onChange={this.handleChange}/>
